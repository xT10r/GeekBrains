...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Раздели интернет-магазина';
...
INSERT INTO `catalogs` VALUES (1,'Процессоры'),(2,'Мат. платы'),(3,'Видеокарты'),(4,'Оперативная память'),(5,'Мониторы');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `checkNull_products` BEFORE INSERT ON `products` FOR EACH ROW BEGIN
...
--
-- Table structure for table `upcase_catalogs`
--
...
CREATE TABLE `upcase_catalogs` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Раздели интернет-магазина';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `upcase_catalogs`
--

LOCK TABLES `upcase_catalogs` WRITE;
/*!40000 ALTER TABLE `upcase_catalogs` DISABLE KEYS */;
INSERT INTO `upcase_catalogs` VALUES (1,'ПРОЦЕССОРЫ'),(2,'МАТ. ПЛАТЫ'),(3,'ВИДЕОКАРТЫ'),(4,'ОПЕРАТИВНАЯ ПАМЯТЬ');
/*!40000 ALTER TABLE `upcase_catalogs` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-09 22:52:15
