...
CREATE TABLE `files_metadata` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `index_of_owner_id` (`owner_id`),
  KEY `index_of_tag_id` (`tag_id`),
  KEY `index_of_style_id` (`style_id`),
  CONSTRAINT `files_metadata_ibfk_1` FOREIGN KEY (`owner_id`) REFERENCES `owners` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `files_metadata_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `files_metadata_ibfk_3` FOREIGN KEY (`style_id`) REFERENCES `styles` (`id`) ON UPDATE CASCADE
...
INSERT INTO `files_metadata` VALUES (1,1,'robot.mp3','/opt/storage_media/content/music/robot.mp3',1,'001 - Robot','m$tool','Nothing see here',1),(2,2,'1965_Bunny_Lake_Is_Missing.mkv','/opt/storage_media/content/movies/1965_Bunny_Lake_Is_Missing.mkv',2,'Bunny Lake Is Missing','Otto Preminger','A woman reports that her young daughter is missing, but there seems to be no evidence that she ever existed',2),(3,3,'1982_E.T._The_Extra-Terrestrial.mkv','/opt/storage_media/content/movies/1982_E.T._The_Extra-Terrestrial.mkv',2,'E.T. the Extra-Terrestrial','Steven Spielberg','A troubled child summons the courage to help a friendly alien escape Earth and return to his home world.',3),(4,4,'1827-The_Death_Of_Sardanapalus.jpg','/opt/storage_media/content/pictures/1827/1827-The_Death_Of_Sardanapalus.jpg',3,'The Death of Sardanapalus','Eugene Delacroix','The composition shows the bearded Sardanapalus lounging (upper left) on a sumptuous divan, in the midst of an orgy of death and destruction',4);
...
INSERT INTO `owners` VALUES (1,'Petrov Ivan'),(2,'Samoylov Michael'),(3,'Ivanov Kirill'),(4,'Simonov Piter'),(5,'Kalinov Denis');
...
CREATE TABLE `styles` (
  `id` int NOT NULL,
  `style_name` varchar(256) DEFAULT NULL COMMENT 'жанр, направление, стиль',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `styles` VALUES (1,'Techno'),(2,'Drama'),(3,'Adventure'),(4,'Romanticism');
...
INSERT INTO `tags` VALUES (1,'audio'),(2,'video'),(3,'picture');
...
-- Dump completed on 2022-01-04 17:11:43
